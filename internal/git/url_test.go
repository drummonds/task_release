...
func TestURLToWeb(t *testing.T) {
	tests := []struct {
		...
		{"https", "https://github.com/drummonds/task-plus", "https://github.com/drummonds/task-plus"},
		{"https .git", "https://github.com/drummonds/task-plus.git", "https://github.com/drummonds/task-plus"},
